    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="primary" size="mini" @click="centerDialogVisiable = true">添加歌曲</el-button>
            </div>
        </div>
        ...
        <el-dialog title="添加歌曲" :visible.sync="centerDialogVisiable" width="400px" center>
            ...
            <span slot="footer">
                <el-button size="mini" @click="centerDialogVisiable = false">取消</el-button>
...
export default {
    ...
    data() {
        return {
            singerId: '', //歌手id
            singerName: '', //歌手名
            centerDialogVisiable: false, //添加弹窗是否显示
    ...
    watch: {
        // 搜索框内容变化时，搜索结果table列表的内容跟着它的内容发生变化
    ...
    methods: {
        ...
        addSong() {
            ...
            req.onreadystatechange = function() {
                //req.readyState == 4表示获取到返回的完整数据
                //req.status == 200表示和后台正常交互完成
            ...
            _this.centerDialogVisiable = false;
        },
        // 弹出编辑页面
        handleEdit(row) {
        ...
        // 切换播放歌曲
        setSongUrl(url, name) {
            // 如果此时toggle不等于传入的歌名，则播放歌曲，否则暂停此歌曲
            if(this.toggle != name) {
                this.toggle = name;
